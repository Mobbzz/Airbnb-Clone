  ...
  if (!user.token) {
    return (
      <div className="container mx-auto p-8 text-gray-800">
        <h1 className="text-3xl font-bold text-red-600 mb-6">Add Accommodation</h1>
        <p className="text-lg text-gray-800">
          You need to <Link to="/login" className="text-red-600 hover:underline">log in</Link> or{' '}
          <Link to="/register" className="text-red-600 hover:underline">register</Link> to add accommodation.
        </p>
      </div>
    );
  }
    ...
    <div className="container mx-auto p-8 text-gray-800">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input
          ...
          required
          className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-600"
        />
        <input
          type="text"
          name="host"
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-600"
          />
          <button type="button" onClick={handleAddImage} className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700">
            Add Image
          </button>
        </div>
